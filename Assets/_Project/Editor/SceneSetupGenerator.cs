    ...
    public static class SceneSetupGenerator
    {
        ...
        public static void GenerateAll()
        {
            ...
            EditorBuildSettings.scenes = new[]
            {
                ...
                new EditorBuildSettingsScene($"{ScenesPath}/02_Game.unity", true)
            };
        ...
        private static void CreateGameScene()
        {
            ...
            for (var i = 0; i < 10; i++)
            {
                ...
                sp.transform.position = new Vector3(i * 3f - 13.5f, 0f, 0f);
            }
            ...
            EditorSceneManager.SaveScene(scene, $"{ScenesPath}/02_Game.unity");
        }
    }
}
#endif
