...
namespace FusionMultiplayer.EditorTools
{
    ...
    internal static class UILayoutPatcher
    {
        ...
        private const string GamePath = "Assets/_Project/Scenes/02_Game.unity";
        ...
        {
            foreach (var path in new[] { MainMenuPath, LobbyPath, GamePath })
            {
        ...
        [MenuItem("Tools/Fusion Multiplayer/Strip Legacy Game HUD (02_Game)")]
        public static void StripLegacyGameHudMenu()
        {
            ...
            EditorSceneManager.MarkSceneDirty(scene);
            EditorSceneManager.SaveScene(scene);
            Debug.Log("[FusionMultiplayer] Legacy CharacterSelectPanel / ChatPanel removed from 02_Game. Runtime rebuild creates HUD at Play.");
        }
