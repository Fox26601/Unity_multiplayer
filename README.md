...
3D coursework prototype: **Shared Mode** lobby + game, master-approved character slots, chat (incl. whisper by nickname), spawn/despawn blocks, master game-over flow.
